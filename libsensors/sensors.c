...
static const struct sensor_t sSensorList[] = {
        { "AK8976A 3-axis Accelerometer",
                ...
                SENSOR_TYPE_ACCELEROMETER, 2.8f*9.81f, 9.81f/45.0f, 3.0f, 500, { } },
        { "AK8976A 3-axis Magnetic field sensor",
                "Asahi Kasei",
                1, SENSORS_HANDLE_BASE+ID_M,
                SENSOR_TYPE_MAGNETIC_FIELD, 2000.0f, 1.0f, 6.7f, 1000, { } },
        { "AK8976A Orientation sensor",
                "Asahi Kasei",
                1, SENSORS_HANDLE_BASE+ID_O,
                SENSOR_TYPE_ORIENTATION, 360.0f, 1.0f, 9.7f, 100, { } },
        { "AK8976A Temperature sensor",
                "Asahi Kasei",
                1, SENSORS_HANDLE_BASE+ID_T,
                SENSOR_TYPE_TEMPERATURE, 115.0f, 1.6f, 3.0f, 500, { } },
};
